...
from paper2saas.prompts.research import VALIDATION_RESEARCHER_INSTRUCTIONS
...
validation_researcher = create_agent(
    name="Validation Researcher",
    instructions=VALIDATION_RESEARCHER_INSTRUCTIONS,
    tools=_tools,
    model_id=AgentConfig.VALIDATION_RESEARCHER_MODEL,
)
